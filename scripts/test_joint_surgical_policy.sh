...
do
python -u imitate_episodes.py \
--task_name $task_name --ckpt_dir checkpoint_m/$model/$task_name-rope30/ --policy_class $model --kl_weight 200 --chunk_size $chunk_size --hidden_dim 512 --batch_size 6 --dim_feedforward 3200 --state_dim 14 --action_dim 14 --num_steps 100000 --lr 75e-7 --seed 0 --is_surgical  --eval_every 2500 --save_every 5000 --temporal_agg --is_joint
done
done
done
